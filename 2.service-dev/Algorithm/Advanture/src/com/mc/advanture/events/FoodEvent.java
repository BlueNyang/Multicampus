...
import com.mc.advanture.items.Food;
import com.mc.advanture.items.data.Foods;
...
public class FoodEvent implements Event {
    ...
    private EventResult EatOneAndStoreRest(Player player, Food food) {System.out.println("[System] You chose to eat the food.");

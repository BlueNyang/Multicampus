...
INSERT INTO STUDENT (sNo, sName, sYear, deptNo)
VALUES ('S004', 'Alice', 2, '001');
-- 값 string은 small quotes로 wrapping

-- 반드시 column 순서에 맞춰야 함
INSERT INTO STUDENT
VALUES ('S005', 'Alice', '002', 2);

-- BOOK table에 data 삽입 전 publisher 추가
INSERT INTO PUBLISHER (pubNo, pubName)
VALUES ('P001', 'Tech Books');

-- BOOK table에 data 삽입
INSERT INTO BOOK
VALUES ('B001', 'SQL Basics', 23000, TO_DATE('2019-01-01', 'YYYY-MM-DD'), 'P001');

-- Book table 데이터 조회
SELECT * FROM BOOK;

-- SELECT EX
SELECT bookname FROM book WHERE bookNo = 'B001';

-- 여러 개의 DATA를 저장: INSERT INTO ALL INTO table_name (cols) VALUES (values) INTO ... 
INSERT ALL
    INTO BOOK VALUES('B002', 'Database', 35000, TO_DATE('2021-05-12', 'YYYY-MM-DD'), 'P001')
    INTO BOOK VALUES('B003', 'Algorithms', 35000, TO_DATE('2020-05-12', 'YYYY-MM-DD'), 'P001')
SELECT * FROM dual;

-- 같은 table에 여러 data를 저장: INSERT INTO table_name (cols) SELECT (cols) FROM dual UNION ALL SELECT ...;
INSERT INTO BOOK
SELECT 'B004', 'Database', 35000, TO_DATE('2021-05-12', 'YYYY-MM-DD'), 'P001' FROM dual
UNION ALL
SELECT 'B005', 'Algorithms', 35000, TO_DATE('2020-05-12', 'YYYY-MM-DD'), 'P001' FROM dual;

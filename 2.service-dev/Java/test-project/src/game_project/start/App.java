...
import game_project.game.IGameController;
import game_project.game.HangmanController;
import game_project.game.NumberBaseballController;
import game_project.user.User;
import game_project.user.IUserService;
import game_project.user.UserService;
        ...
        switch (choice) {
            ...
            case "5" -> {
                ...
                if (isLoggedIn) {
                    ...
                    if (user.isPresent()) {
                        isLoggedIn = true;
                        currentUserId = user.get().getUserId();
                        menu[4] = "User Menu (Logged in as " + user.get().getUsername() + ")";
    ...
    private boolean handleSubMenuChoice(String choice) {
        ...
        switch (choice) {
            ...
            case "1" -> {
                ...
                if (user.isPresent()) {
                    System.out.println("User Profile: " + user.get());
                } else {

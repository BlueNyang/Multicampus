package kr.bluenyang.practice.spring.sec01_xml_constructor;
...
public class NameMain {
    public static void main(String[] args) {
        ...
        AbstractApplicationContext ctx = new GenericXmlApplicationContext("application-context-sec01.xml");

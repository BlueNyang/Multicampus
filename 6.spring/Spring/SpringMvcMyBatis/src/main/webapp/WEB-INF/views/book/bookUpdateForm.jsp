...
<html>
  ...
  <body>
    ...
    <form name="updateBook" method="post" action="<c:url value="/book/updateBook"/>">
      ...
      <input name="bookName" id="bookName" type="text" value="${book.bookName}"/>
      <label for="bookAuthor">저자</label>
      <input name="bookAuthor" id="bookAuthor" type="text" value="${book.bookAuthor}"/>
      <label for="bookPrice">도서가격</label>
      <input name="bookPrice" id="bookPrice" type="number" value="${book.bookPrice}"/>
      <label for="bookDate">출간일</label>
      <input
         name="bookDate" id="bookDate" type="date"
         value="<fmt:formatDate value="${book.bookDate}" pattern="yyyy-MM-dd"/>"
      />

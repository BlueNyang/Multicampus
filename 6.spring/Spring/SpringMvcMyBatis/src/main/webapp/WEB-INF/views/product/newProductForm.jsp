...
<html>
  <head>
    ...
    <%-- <script src="<c:url value="/resources/js/ajax/prdNoCheck.js"/>"></script> --%>
    <%-- <script src="<c:url value="/resources/js/ajax/prdNoCheck2.js"/>"></script> --%>
    <%-- <script src="<c:url value="/resources/js/ajax/prdNoCheck3.js"/>"></script> --%>
    <script src="<c:url value='/resources/js/axios.min.js'/>"></script>
    <%-- <script src="<c:url value="/resources/js/ajax/prdNoCheck4.js"/>"></script> --%>
    <script src="<c:url value="/resources/js/ajax/prdNoCheck5.js"/>"></script>
  </head>
  <body>
    <h3>상품 정보 등록</h3>
    <!--  index 페이지로 이동 링크 추가 -->

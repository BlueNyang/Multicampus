...
public class NumberBaseballGameService {
    ...
    private final List<NumberBaseballTryVo> attempts;
    private NumberBaseballStatus status;

    public NumberBaseballGameService(List<Integer> secretNumber, List<NumberBaseballTryVo> attempts, NumberBaseballStatus status) {
